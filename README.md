...
# Cybergrind Music Explorer / CGME

### Enhanced music browser, downloader and player for Cyber Grind
...
## Downloader
![Downloader](https://i.imgur.com/t1u9LFv.png)
...
### YouTube may or may not want you to get logged in
...
_Important: I highly recommend using a dedicated, fresh YouTube account for that due to security concerns_

### No matter how hard I try there's a bunch of tracks I just can't download. Why?
...
### I seem not to be able to download any of them
...
![Calm and battle themes](https://i.imgur.com/uoIF5Y8.png)
