...
using TagLib;
using UnityEngine;
using static Jukebox.Utils.GenericUtils;
...
namespace Jukebox.Core.Model.Song
{
    public class JukeboxSongMetadata
    {
        ...
        public static JukeboxSongMetadata From(AssetReferenceSoundtrackSong reference)
        {
            ...
            return new(addressable.icon, addressable.songName, GetSongComponents(reference.AssetGUID, addressable), addressable.extraLevelBit);
        }
